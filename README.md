...
Event-driven orchestrator for massively parallelized backtests of trading strategies. It runs your strategy while capturing each computation step for inspection.
